...
// just main func that takes all together
func main() {
...
// func that returns first element from array with all stuff
...
// func that initialize stuff array with random values: 500 +- 350
