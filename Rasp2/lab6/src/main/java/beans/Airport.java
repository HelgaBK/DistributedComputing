...
public class Airport implements Serializable {
    ...
    public void setAircompanies(ArrayList<Aircompany> list){aircompanies = list;}
    ...
    public void deleteAircompany(int code) throws Exception{
        ...
        if(aircompanyToDelete == null){
            throw new Exception("main.beans.Aircompany doesnt exist");
        }
    ...
    public void addFlight(int code, String from, String to, int aircompanyCode) throws Exception{
        Aircompany aircompany = getAirCompany(aircompanyCode);
        if(aircompany == null){
            throw new Exception("main.beans.Aircompany doesnt exist");
        }
